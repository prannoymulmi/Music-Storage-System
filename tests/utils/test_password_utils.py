...
def test_is_password_policy_non_compliant_when_non_compliant_longer_than_50_password_then_return_true():
    result = PasswordUtil.is_password_policy_non_compliant(
        "!FPSEwB^KMuzep6bK6@1rrPJZx!8T78S2v6J2aUNF1ZKKavpDfasdasdasdasdsadasdasdasdasdasdasd")
    assert result
