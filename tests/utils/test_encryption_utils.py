...
def test_encryption_util_is_singleton():
    instance = EncryptionUtils.instance()
    assert isinstance(instance, EncryptionUtils)


def test_encryption_util_is_throws_error_if_tried_to_create_object():
